...
} else if (this.needsFocus(r)) return t.timeStamp - n > 100 || deviceIsIOS && window.top !== window && "input" === o ? (this.targetElement = null, 
!1) :(this.focus(r), this.sendClick(r, t), deviceIsIOS && "select" === o || (this.targetElement = null, 
t.preventDefault()), !1);
...
if (c == n) for (var r in o) o.hasOwnProperty(r) && (a[r] = o[r]);
a[c] = s[c];
}
...
var o = e.Token, i = [ t ], s = n.rest;
if (s) {
for (var r in s) n[r] = s[r];
delete n.rest;
}
t:for (var r in n) if (n.hasOwnProperty(r) && n[r]) {
var a = n[r];
a = "Array" === e.util.type(a) ? a :[ a ];
for (var c = 0; c < a.length; ++c) {
var l = a[c], u = l.inside, p = !!l.lookbehind, h = 0, d = l.alias;
l = l.pattern || l;
...
if (y) {
p && (h = y[1].length);
var m = y.index - 1 + h, y = y[0].slice(h), v = y.length, w = m + v, b = g.slice(0, m + 1), _ = g.slice(w + 1), k = [ f, 1 ];
b && k.push(b);
...
run:function(t, n) {
var o = e.hooks.all[t];
if (o && o.length) for (var i, s = 0; i = o[s++]; ) i(n);
}
}
...
function u(t, e) {
var n, o;
if (s(t.length)) for (n in t) l(t, n) && e.call(null, n, t[n]); else if (o = t.length) for (n = 0; o > n; n++) e.call(null, n, t[n]);
}
function p() {
...
for (var e = t.context, n = ~~(e.length / 2), o = e.length, i = !1; o--; ) if (e[o].length > 300) {
i = !0;
break;
}
if (i) {
...
c(t.extra) && delete t.extra, R && (t.user = R), r(O.dataCallback) && (t = O.dataCallback(t)), 
(!r(O.shouldSendCallback) || O.shouldSendCallback(t)) && (L = t.event_id || (t.event_id = C()), 
b(t)));
}
function b(t) {
var e = new Image(), o = N + A + "&sentry_data=" + encodeURIComponent(JSON.stringify(t));
e.onload = function() {
n("success", {
data:t,
src:o
...
var r = null;
if (m) x.computeStackTrace.augmentStackTraceWithInitialElement(m, e, n, t), u(); else if (i) r = x.computeStackTrace(i), 
s(r, !0); else {
var a = {
url:e,
line:n,
...
var h, d, f = [], g = null, y = null, m = null;
...
if (!l(_, t)) {
var n = "";
-1 !== t.indexOf(document.domain) && (n = e(t)), _[t] = n ? n.split("\n") :[];
}
return _[t];
}
function o(t, e) {
var o, i = /function ([^(]*)\(([^)]*)\)/, r = /['"]?([0-9A-Za-z$_]+)['"]?\s*[:=]\s*(function|eval|new Function)/, a = "", c = 10, l = n(t);
if (!l.length) return P;
for (var u = 0; c > u; ++u) if (a = l[e - u] + a, !s(a)) {
...
var i = [], r = Math.floor(x.linesOfContext / 2), a = r + x.linesOfContext % 2, c = Math.max(0, e - r - 1), l = Math.min(o.length, e + a - 1);
e -= 1;
...
function u(t, e) {
for (var o, i, s = 0, r = e.length; r > s; ++s) if ((o = n(e[s])).length && (o = o.join("\n"), 
i = t.exec(o))) return {
url:e[s],
...
function p(t, e, o) {
var i, s = n(e), a = new RegExp("\\b" + r(t) + "\\b");
...
if (i = h.exec(p)) {
var y = i[1] ? "\\s+" + i[1] :"", m = i[2].split(",").join("\\s*,\\s*");
...
var r, a, p, h, d = /^\s*Line (\d+) of linked script ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i, f = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i, g = /^\s*Line (\d+) of function script\s*$/i, y = [], m = document.getElementsByTagName("script"), v = [];
...
var C = t.location.href.replace(/#.*$/, ""), S = r[1], E = new RegExp(c(s[a + 1]));
h = u(E, [ C ]), w = {
url:C,
line:h ? h.line :S,
func:""
...
var x = i(w.url, w.line), T = x ? x[Math.floor(x.length / 2)] :null;
...
function m(t, e) {
for (var n, i, s, r = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, a = [], c = {}, l = !1, u = m.caller; u && !l; u = u.caller) if (u !== v && u !== x.report) {
if (i = {
url:null,
func:P,
line:null,
...
var D, L, N, R, I, $, A, B = t.Raven, M = !(!t.JSON || !t.JSON.stringify), O = {
logger:"javascript",
ignoreErrors:[],
ignoreUrls:[],
whitelistUrls:[],
...
if (!t) return F;
var n = i(t), o = n.path.lastIndexOf("/"), s = n.path.substr(1, o);
...
var H = "source protocol user pass host port path".split(" "), U = /^(?:(\w+):)?\/\/(\w+)(:\w+)?@([\w\.-]+)(?::(\d+))?(\/.*)/;
...
var o, i, r;
n.headers || (n.headers = {}), n.contentType && (n.headers["Content-Type"] = n.contentType), 
!n.headers["Content-Type"] && n.data && "GET" !== n.type && (n.headers["Content-Type"] = "application/x-www-form-urlencoded"), 
...
on:function(t, e) {
var n, o, i, s, r;
if (t.indexOf(" ") >= 0) for (r = t.split(" "), i = 0, s = r.length; s > i; i++) n = r[i], 
this.on(n, e); else (null != (o = null != this._callbacks ? this._callbacks :this._callbacks = {})[t] ? o[t] :o[t] = []).push(e);
return this;
},
off:function(t, e) {
var n, o, i, s, r, a, c;
if (t.indexOf(" ") >= 0) for (a = t.split(" "), s = 0, r = a.length; r > s; s++) i = a[s], 
this.off(i, e); else (n = null != (c = this._callbacks) ? c[t] :void 0) && (o = n.indexOf(e)) >= 0 && (n.splice(o, 1), 
n.length || delete this._callbacks[t]);
return this;
},
trigger:function() {
var e, n, o, i, s, r, a, c;
if (i = arguments[0], e = 2 <= arguments.length ? t.call(arguments, 1) :[], o = null != (a = this._callbacks) ? a[i] :void 0) for (c = o.slice(0), 
...
var e, n, o, i;
if (null != this._callbacks) for (i = t.split(" "), n = 0, o = i.length; o > n; n++) e = i[n], 
...
for (c = i.slice(1), n = r = 0, a = c.length; a > r; n = ++r) s = c[n], "string" == typeof s && (s = decodeURIComponent(s)), 
(o = this.keys[n]) ? e[o.name] = s :e.push(s);
return !0;
}
}, t;
}(), c = function(t, e) {
...
var i, s, r, a;
if (null == o && (o = !1), e.indexOf(" ") >= 0) for (a = e.split(" "), s = 0, r = a.length; r > s; s++) i = a[s], 
...
var e, n, o, i, s;
if (n = document.createDocumentFragment(), $.isCollection(t)) for (s = $.makeArray(t), 
o = 0, i = s.length; i > o; o++) e = s[o], n.appendChild(e); else n.innerHTML = t;
return n;
}, $.append = function(t, e) {
...
var e, n, o, i;
if ($.isCollection(t)) for (i = $.makeArray(t), n = 0, o = i.length; o > n; n++) e = i[n], 
e.parentElement.removeChild(e); else t.parentElement.removeChild(t);
}, $.empty = function(t) {
...
for (var e; (t = t.parentElement) && !(t.scrollTop > 0) && "auto" !== (e = getComputedStyle(t).overflowY) && "scroll" !== e; ) ;
return t;
...
null == o && (o = $.scrollParent(e)), o) for ($.scrollTo.apply($, [ e, o ].concat(s.call(t))), 
...
a = n.length; a > r; r++) if (e = n[r]) for (t in e) i = e[t], o[t] = i;
return o;
...
return this.isSupportedBrowser() ? !0 :(document.body.className = "", document.body.innerHTML = app.templates.unsupportedBrowser, 
!1);
},
...
bootAll:function() {
var t, e, n, o, i;
for (e = this.settings.getDocs(), i = this.DOCS, n = 0, o = i.length; o > n; n++) t = i[n], 
(e.indexOf(t.slug) >= 0 ? this.docs :this.disabledDocs).add(t);
...
for (o in n) if (i = n[o], !i) return Raven.captureMessage("unsupported/" + o), 
!1;
return !0;
} catch (s) {
...
return $.extend(t.prototype, Events), t.routes = [ [ "*", "before" ], [ "/", "root" ], [ "/offline", "offline" ], [ "/about", "about" ], [ "/news", "news" ], [ "/help", "help" ], [ "/:doc-:type/", "type" ], [ "/:doc/", "doc" ], [ "/:doc/:path(*)", "entry" ], [ "*", "notFound" ] ], 
...
}, b = {}.hasOwnProperty, _ = function(t, e) {
function n() {
this.constructor = t;
}
...
var e;
return !t.target.form && 65 <= (e = t.which) && 90 >= e ? void this.trigger("typing") :32 === t.which ? (this.trigger("pageUp"), 
!1) :void 0;
...
var e, n, o, i;
if (t instanceof app.Model) this.models.push(t); else if (t instanceof Array) for (n = 0, 
o = t.length; o > n; n++) e = t[n], this.add(e); else t instanceof app.Collection ? (i = this.models).push.apply(i, t.all()) :this.models.push(new (this.model())(t));
...
var n, o, i, s;
for (s = this.models, o = 0, i = s.length; i > o; o++) if (n = s[o], n[t] === e) return n;
...
var t, e, n, o;
if (this.el.className = this.originalClassName || "", this.constructor.className) for (o = this.constructor.className.split(" "), 
...
var t, e, n, o;
if (!this.activated) {
if (this.bindEvents(), this.subviews) for (o = this.subviews, e = 0, n = o.length; n > e; e++) t = o[e], 
t.activate();
...
var t, e, n, o;
if (this.activated) {
if (this.unbindEvents(), this.subviews) for (o = this.subviews, e = 0, n = o.length; n > e; e++) t = o[e], 
t.deactivate();
...
var t;
if (this.entry && !this.cacheMap[t = this.entry.filePath()]) for (this.cacheMap[t] = this.el.innerHTML, 
...
var t;
return this.cacheMap[t = this.entry.filePath()] ? (this.render(this.cacheMap[t]), 
!0) :void 0;
}, o.prototype.onClick = function(t) {
...
return function(e) {
var n, o, i, s, r;
if (t.activated) if (e === !1) t.html(t.tmpl("offlineError")); else {
...
var e, n, o;
if (e = this.data.indexOf(t), e >= i) for (n = 0, o = Math.floor(e / i); o >= 0 ? o > n :n > o; o >= 0 ? n++ :n--) this.paginateNext();
...
var n, o, i;
if ($.isCollection(t)) for (o = 0, i = t.length; i > o; o++) n = t[o], this.highlightCode(n, e); else t && (t.classList.add("language-" + e), 
...
var t, e;
this.listSelect.deselect(), null != (e = this.listFocus) && e.blur(), this.listFold.reset(), 
...
var t, e, n, o, i;
for (o = this.findAllByTag("input"), i = [], e = 0, n = o.length; n > e; e++) t = o[e], 
(null != t ? t.checked :void 0) && i.push(t.name);
return i;
}, o.prototype.onClick = function(t) {
...
}, t = [ [ "Angular.js", "2010-2014 Google, Inc.", "CC BY", "http://creativecommons.org/licenses/by/3.0/" ], [ "Backbone.js", "2010-2014 Jeremy Ashkenas, DocumentCloud", "MIT", "https://raw.github.com/jashkenas/backbone/master/LICENSE" ], [ "Bower", "2014 Bower contributors", "CC BY", "https://github.com/bower/bower.github.io/blob/b7b94ad38b72e8fb5dafb20c8ce42835a49cc98f/package.json#L20" ], [ "C<br>C++", "cppreference.com", "CC BY-SA", "http://en.cppreference.com/w/Cppreference:Copyright/CC-BY-SA" ], [ "Chai", "2011-2014 Jake Luer", "MIT", "https://github.com/chaijs/chai/blob/master/README.md#license" ], [ "CoffeeScript", "2009-2014 Jeremy Ashkenas", "MIT", "https://raw.github.com/jashkenas/coffee-script/master/LICENSE" ], [ "Cordova", "2012-2014 The Apache Software Foundation", "Apache", "https://raw.githubusercontent.com/apache/cordova-docs/master/LICENSE" ], [ "CSS<br>DOM<br>HTML<br>JavaScript<br>SVG<br>XPath", "2005-2014 Mozilla Developer Network and individual contributors", "CC BY-SA", "http://creativecommons.org/licenses/by-sa/2.5/" ], [ "D3.js", "2014 Michael Bostock", "BSD", "https://raw.github.com/mbostock/d3/master/LICENSE" ], [ "Django", "Django Software Foundation and individual contributors", "BSD", "https://raw.githubusercontent.com/django/django/master/LICENSE" ], [ "Ember.js", "2014 Yehuda Katz, Tom Dale and Ember.js contributors", "MIT", "https://raw.github.com/emberjs/ember.js/master/LICENSE" ], [ "Express", "2009-2014 TJ Holowaychuk", "MIT", "https://raw.githubusercontent.com/visionmedia/express/master/LICENSE" ], [ "Git", "2005-2014 Linus Torvalds and others", "GPLv2", "https://raw.github.com/git/git/master/COPYING" ], [ "Go", "Google, Inc.", "CC BY", "http://creativecommons.org/licenses/by/3.0/" ], [ "Grunt", "2014 Grunt Team", "MIT", "https://raw.githubusercontent.com/gruntjs/gruntjs.com/master/LICENSE" ], [ "Haskell", "The University of Glasgow", "BSD", "http://www.haskell.org/ghc/license" ], [ "HTTP", "1999 The Internet Society", "Custom", "http://www.w3.org/Protocols/rfc2616/rfc2616-sec21.html#sec21" ], [ "jQuery", "2009 Packt Publishing<br>&copy; 2014 jQuery Foundation", "MIT", "https://raw.github.com/jquery/api.jquery.com/master/LICENSE-MIT.txt" ], [ "jQuery Mobile", "2014 jQuery Foundation", "MIT", "https://raw.github.com/jquery/api.jquerymobile.com/master/LICENSE-MIT.txt" ], [ "jQuery UI", "2014 jQuery Foundation", "MIT", "https://raw.github.com/jquery/api.jqueryui.com/master/LICENSE-MIT.txt" ], [ "Knockout.js", "Steven Sanderson, the Knockout.js team, and other contributors", "MIT", "https://raw.github.com/knockout/knockout/master/LICENSE" ], [ "Laravel", "Taylor Otwell", "MIT", "https://raw.githubusercontent.com/laravel/framework/master/LICENSE.txt" ], [ "Less", "2009-2014 The Core Less Team", "CC BY", "http://creativecommons.org/licenses/by/3.0/" ], [ "Lo-Dash", "2009-2014 The Dojo Foundation", "MIT", "https://raw.github.com/lodash/lodash/master/LICENSE.txt" ], [ "Marionette.js", "2014 Muted Solutions, LLC", "MIT", "http://mutedsolutions.mit-license.org/" ], [ "Markdown", "2004 John Gruber", "BSD", "http://daringfireball.net/projects/markdown/license" ], [ "MaxCDN", "2014 MaxCDN", "MIT", "https://raw.githubusercontent.com/MaxCDN/api-docs/master/LICENSE" ], [ "Modernizr", "2009-2014 Modernizr", "MIT", "http://modernizr.com/license/" ], [ "Moment.js", "2011-2014 Tim Wood, Iskren Chernev, Moment.js contributors", "MIT", "https://raw.github.com/moment/moment/master/LICENSE" ], [ "Mongoose", "2010 LearnBoost", "MIT", "https://github.com/LearnBoost/mongoose/blob/master/README.md#license" ], [ "nginx", "2002-2014 Igor Sysoev<br>&copy; 2011-2014 Nginx, Inc.", "BSD", "http://nginx.org/LICENSE" ], [ "Node.js", "Joyent, Inc. and other Node contributors<br>Node.js is a trademark of Joyent, Inc.", "MIT", "https://raw.github.com/joyent/node/master/LICENSE" ], [ "Nokogiri", "2008-2014 2014 Aaron Patterson, Mike Dalessio, Charles Nutter, Sergio Arbeo, Patrick Mahoney, Yoko Harada, Akinori Musha", "MIT", "https://github.com/sparklemotion/nokogiri/blob/master/README.rdoc#license" ], [ "PHP", "1997-2014 The PHP Documentation Group", "CC BY", "http://creativecommons.org/licenses/by/3.0/" ], [ "PHPUnit", "2005-2014 Sebastian Bergmann", "CC BY", "http://creativecommons.org/licenses/by/3.0/" ], [ "PostgreSQL", "1996-2013 The PostgreSQL Global Development Group<br>&copy; 1994 The Regents of the University of California", "PostgreSQL", "http://www.postgresql.org/about/licence/" ], [ "Python", "1990-2014 Python Software Foundation<br>Python is a trademark of the Python Software Foundation.", "PSFL", "http://docs.python.org/3/license.html" ], [ "React", "2013-2014 Facebook Inc.", "CC BY", "https://raw.githubusercontent.com/facebook/react/master/LICENSE-docs" ], [ "Redis", "2009-2014 Salvatore Sanfilippo", "CC BY-SA", "http://creativecommons.org/licenses/by-sa/4.0/" ], [ "RequireJS", "2010-2014 The Dojo Foundation", "MIT", "https://raw.githubusercontent.com/jrburke/requirejs/master/LICENSE" ], [ "RethinkDB", "RethinkDB contributors", "CC BY-SA", "https://raw.githubusercontent.com/rethinkdb/docs/master/LICENSE" ], [ "Ruby", "1993-2014 Yukihiro Matsumoto", "Ruby", "https://www.ruby-lang.org/en/about/license.txt" ], [ "Ruby on Rails", "2004-2014 David Heinemeier Hansson<br>Rails, Ruby on Rails, and the Rails logo are trademarks of David Heinemeier Hansson.", "MIT", "https://raw.github.com/rails/rails/master/activerecord/MIT-LICENSE" ], [ "Sass", "2006-2014 Hampton Catlin, Nathan Weizenbaum, and Chris Eppstein", "MIT", "https://raw.github.com/nex3/sass/master/MIT-LICENSE" ], [ "Sinon", "2010-2014 Christian Johansen", "BSD", "https://raw.githubusercontent.com/cjohansen/Sinon.JS/master/LICENSE" ], [ "Socket.io", "2014 Automattic", "MIT", "https://raw.githubusercontent.com/Automattic/socket.io/master/LICENSE" ], [ "Underscore.js", "2009-2014 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors", "MIT", "https://raw.github.com/jashkenas/underscore/master/LICENSE" ], [ "Yii", "2008-2014 by Yii Software LLC", "BSD", "https://raw.github.com/yiisoft/yii/master/LICENSE" ] ];
}.call(this), function() {
var t, e;
